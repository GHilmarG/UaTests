...
switch Experiment
    ...
    case "Compare with ref: mesh convergence"  % Mesh convergence for Cornford
        ...
        SubString(9)="-FT-P-Duvh-TWIS-MR4-SM-TM001-5km-Alim-Clim-Ca1-Cs100000-Aa1-As100000-InvMR5.mat"            ; % 500 years with collapse 
...
if CreateVideo
    ...
    for I=IRange
        ...
        ReadPlotSequenceOfResultFiles2(FileNameSubstring=SubString(I),PlotTimestep=Step,PlotType="-ds-VAF-dSLRdt-",VAFBoundary=xyBoundary,PlotTimeInterval=TimeInterval) ;
    end
end
