...
function LevelSetFixPointSolver()
...
if contains(CtrlVar.LevelSetFixPointSolverApproach,"IFP")
    ...
    CtrlVar.LevelSetTheta=1; CtrlVar.LevelSetSolverMaxIterations=4;
    [UserVar,RunInfo,LSF,l,LSFqx,LSFqy]=LevelSetEquationNewtonRaphson(UserVar,RunInfo,CtrlVar,MUA,BCs,F0,F1,l);
end


if contains(CtrlVar.LevelSetFixPointSolverApproach,"PTS")  && ~RunInfo.LevelSet.SolverConverged
...
CtrlVar.dt=dtOld;
if contains(CtrlVar.LevelSetFixPointSolverApproach,"FFP")
