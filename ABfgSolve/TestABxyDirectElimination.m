...
Klear 
load solveKApeTestSave_pre.mat 

[B,g,isLLunity]=ScaleL(CtrlVar,B,g,true);
...
[norm(xTest-xBack)/norm(xBack) norm(xTest2-xBack)/norm(xBack) norm(xTest3-xBack)/norm(xBack) norm(xAL-xBack)/norm(xBack)]

% N=30 ; [xTest(1:N)-xBack(1:N) xTest2(1:N)-xBack(1:N) xTest3(1:N)-xBack(1:N) xBack(1:N)]
