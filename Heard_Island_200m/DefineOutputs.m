...
if contains(plots,'-plot-')
    ...
    FindOrCreateFigure("TwoPlots") ; % ,[50 50 figsWidth 3*figHeights]) ;
    ...
    subplot(2,1,2)
    PlotMeshScalarVariable(CtrlVar,MUA,h.thickness-F.h);   title(sprintf('dh at t=%g',time))
    hold on
