...
%LIELLE MAY 2023 CHANGES TO INCLUDE BETTER RESOLUTION IN INITIAL MESH
%liellebeta
if exist('my_get_t_first0.mat','file')
    if CtrlVar.time==0
      FieldsToBeDefined="-s-b-S-B-rho-rhow-g-";
    end
else
    name=strcat('my_get_t_first',num2str(CtrlVar.time),'.mat');
    currentGeoInCtrlVar=FieldsToBeDefined;
    save(name,'currentGeoInCtrlVar');
end

%%%  LIELLE END of CHANGES
